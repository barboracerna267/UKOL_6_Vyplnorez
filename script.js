...
const fillcut = (str, len) => {
    ...
    const extraDots = len - str.length;
    const dots = '.'.repeat(extraDots);
    return dots + str;
    } else {
...
document.body.innerHTML += fillcut('barbora', 8) + '<br>';
document.body.innerHTML += fillcut('barbora', 3) + '<br>';
document.body.innerHTML += fillcut('barbora', 4) + '<br>';
